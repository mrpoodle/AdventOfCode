def solution(data, n):
    ...
    data = list(data)
    data = list(filter(lambda x: data.count(x) <= n, data))

    return data


a = solution([1, 2, 3], 0)
b = solution([1, 2, 2, 3, 3, 3, 4, 5, 5], 1)
...
and n was 1, solution(data, n) would return the list [5, 15, 7] because 10
...
Input: solution.solution([1, 2, 2, 3, 3, 3, 4, 5, 5], 1) Output:
    1,4
